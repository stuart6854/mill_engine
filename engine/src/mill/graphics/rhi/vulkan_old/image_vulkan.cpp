...
namespace mill::rhi
{
    ImageVulkan::ImageVulkan(
        class InstanceVulkan& device, vk::Image image, vk::ImageUsageFlags usage, vk::Extent3D dimensions, vk::Format format)
    ...
    ImageVulkan::ImageVulkan(InstanceVulkan& device, vk::ImageUsageFlags usage, vk::Extent3D dimensions, vk::Format format, u32 mip_levels)
